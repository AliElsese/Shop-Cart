    ...
    cart.forEach((product, index) => {
        cartSection.innerHTML += `
            <div class="card-item d-flex justify-content-between align-items-center rounded-3 shadow-lg p-3 mb-4">
                ...
                <div class="col-6 col-md-9 d-flex flex-column gap-3 flex-md-row justify-content-between align-items-center">
                    ...
                    <div class="col-12 col-md-3 d-flex justify-content-md-between justify-content-center gap-4 gap-md-0 align-items-center">
